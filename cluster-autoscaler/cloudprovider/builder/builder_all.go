...
import (
	...
	"k8s.io/autoscaler/cluster-autoscaler/cloudprovider/ixcloud"
...
var AvailableCloudProviders = []string{
	...
	cloudprovider.IxCloudProviderName,
}

const DefaultCloudProvider = cloudprovider.IxCloudProviderName

func buildCloudProvider(opts config.AutoscalingOptions, do cloudprovider.NodeGroupDiscoveryOptions, rl *cloudprovider.ResourceLimiter) cloudprovider.CloudProvider {
	switch opts.CloudProviderName {
	case cloudprovider.MagnumProviderName:
		return magnum.BuildMagnum(opts, do, rl)
	case cloudprovider.IxCloudProviderName:
		return ixcloud.BuildIxCloud(opts, do, rl)
	}
	return nil
}
